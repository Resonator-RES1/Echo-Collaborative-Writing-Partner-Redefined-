                            ...
                            <div key={idx} className="p-4 bg-surface-container-highest/30 rounded-2xl border border-outline-variant/10 group">
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex gap-2 bg-surface-container-highest/30 p-2 rounded-lg border border-outline-variant/5 mt-2">
                                            <Info className="w-3.5 h-3.5 text-accent-rose/40 shrink-0 mt-0.5" />
                                            <p className="text-[11px] text-on-surface-variant/80 leading-relaxed italic">{correction.reason}</p>
                                        </div>
                                    </div>
