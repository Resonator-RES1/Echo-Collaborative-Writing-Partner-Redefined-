  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="fixed top-[60px] inset-x-0 mx-auto max-w-4xl h-[60vh] rounded-b-3xl bg-surface-container-lowest/95 backdrop-blur-xl shadow-2xl border-b border-x border-outline-variant/20 z-[60] flex flex-col overflow-hidden"
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
