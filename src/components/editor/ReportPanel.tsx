...
const ReportPanelComponent: React.FC<ReportPanelProps> = ({
    ...
    return (
        <div className="flex flex-col flex-1 min-h-0 overflow-y-auto overflow-x-hidden custom-scrollbar animate-in fade-in duration-500 pt-8 sm:pt-10 pr-2 pb-12">
